...
/*
LineageApiService 根据业务类型&amp;原生ID查询出入度数据血缘
...
func (a *LineageApiService) QueryLineageByNid(ctx context.Context, bizType string, nativeId int64) (ResNodeLineage, *http.Response, error) {
	var (
		...
		localVarReturnValue ResNodeLineage
	)
	...
	localVarQueryParams.Add("ApiAction","QueryLineageByNid")
	localVarQueryParams.Add("ApiVersion","2023-02-10")

	localVarQueryParams.Add("bizType", parameterToString(bizType, ""))
	localVarQueryParams.Add("nativeId", parameterToString(nativeId, ""))
