...
func (a *SubjectApiService) GetSubjectIdTypes(ctx context.Context, subjectId int32) (ListIdType, *http.Response, error) {
	var (
		...
		localVarReturnValue ListIdType
	)
	...
	localVarQueryParams.Add("ApiAction","GetSubjectIdTypes")
...
/*
SubjectApiService 查询主体列表
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param xTenant
 * @param optional nil or *SubjectApiGetSubjectsOpts - Optional Parameters:
     * @param "OrgId" (optional.Int64) - 
...
func (a *SubjectApiService) GetSubjects(ctx context.Context, xTenant int64, localVarOptionals *SubjectApiGetSubjectsOpts) (ListSubjectMeta, *http.Response, error) {
	var (
		...
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue ListSubjectMeta
	)
	...
	localVarQueryParams.Add("Action","QueryOpenPlatformOpenApi")
	localVarQueryParams.Add("Version","2022-12-16")
	localVarQueryParams.Add("ApiAction","GetSubjects")
	localVarQueryParams.Add("ApiVersion","2023-02-10")
