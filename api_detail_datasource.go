...
/*
DetailDatasourceApiService 获取明细数据源的枚举值
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body
 * @param tenantCode 租户ID
 * @param attributeId 要查枚举值的字段id
 * @param optional nil or *DetailDatasourceApiGetDetailAttributesOpts - Optional Parameters:
     * @param "Keyword" (optional.String) -  查询关键字
...
func (a *DetailDatasourceApiService) GetDetailAttributes(ctx context.Context, body DetailAttributesReq, tenantCode string, attributeId string, localVarOptionals *DetailDatasourceApiGetDetailAttributesOpts) (DetailAttributesResp, *http.Response, error) {
	var (
		...
		localVarReturnValue DetailAttributesResp
	)
	...
	localVarQueryParams.Add("attributeId",fmt.Sprintf("%v", attributeId))
	...
	localVarQueryParams.Add("ApiAction","GetDetailAttributes")
