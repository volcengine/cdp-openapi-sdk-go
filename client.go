...
func NewAPIClient(cfg *Configuration) (*APIClient, error) {
	...
	c.DetailDatasourceApi = (*DetailDatasourceApiService)(&c.common)
	c.FileDateAssetApi = (*FileDateAssetApiService)(&c.common)
...
func checkConfig(cfg *Configuration) error {
	...
	if len(cfg.AccessKeySecret) == 0 {
		return errors.New("config AccessKeySecret is empty")
	}
...
func (c *APIClient) prepareRequest(
	...
	signRequest := c.Credential.Sign(localVarRequest)
